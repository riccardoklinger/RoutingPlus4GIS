...
from .RoutingPlus4GIS_routing import RoutingPlus4GISRouting
from .RoutingPlus4GIS_isochrones import RoutingPlus4GISIsochrones


class RoutingPlus4GISProvider(QgsProcessingProvider):
    ...
    def name(self):
        ...
        """
        return self.tr('RoutingPlus4GIS')
